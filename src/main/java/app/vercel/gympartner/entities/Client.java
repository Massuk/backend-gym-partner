...
public class Client extends User{
    ...
    public Client(int idUser, String name, String lastname, String gender, int age, LocalDate birthDate, int cellphone, String email, String dni, boolean hide, String status, String password, Role role, Nutritionist nutritionist, Trainer trainer) {
