...
public class Nutritionist extends User{
    ...
    public Nutritionist(int idUser, String name, String lastname, String gender, int age, LocalDate birthDate, int cellphone, String email, String dni, boolean hide, String status, String password, Role role, double salary, Gym gym) {
